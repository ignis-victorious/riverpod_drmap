    ...
    return Stack(
      children: [
        ...
        ...List.generate(allProvinces.length, (index) {
          ...
          return SvgPicture.asset('./assets/svgs/provinces/${province.code}.svg',
            colorFilter: ColorFilter.mode(
        ...
        ...List.generate(selectedMapAssets.length, (index) {
          ...
          final assetName = seaOrNames ? 
            '${asset.name}_${locale.languageCode}' : asset.name;

          final assetColor = seaOrNames ? ColorFilter.mode(
